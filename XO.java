...
class TimesUpException extends Exception {
    public TimesUpException(String massage) {
        System.out.println(massage);
    }
}
public class TicTacToe {
    ...
    public void playGame() throws IllegalPosException, FullSpaceException, TimesUpException {
        ...
        if(sec > 6){
            throw new TimesUpException("TimesUpException");
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            if(game.WinO()==true){
                System.out.println("O player is win");
                return;
            }
            if(game.WinX()==true){
                System.out.println("X player is win");
                return;
            }
            try {
                game.playGame();
